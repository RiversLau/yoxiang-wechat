...
function getdoctor_therapist(v){
	...
	$.ajax({type:"get",url:host+'title/list?type='+type,
	      async:true,
		   error:function(json){
...
function getArea(){
	$("#area").empty();  
	$.ajax({type:"get",url:host+'area/list?parentId=',
	      async:true,
		   error:function(json){
	    	  console.log('error=json=',json.responseText);
	    	  return;
...
function getArea_Son(){
	...
	$.ajax({type:"get",url:host+'area/list?parentId='+v,
	      async:true,
		  error:function(json){
	    	  console.log('error=json=',json.responseText);
	    	  return;
...
function sumbit_reg(){
	...
	sentData+="}";
	 ...
	 $.ajax({type:"POST",url:host+serverApi,
		   dataType: 'json',
	      contentType: "application/json",
	      data:sentData,
	      async:false,
...
function getMsg(phone){
	var sentData="{'phone':'"+phone+"','type':'doctor_register'}";
	  console.log('sentData=',sentData);
	$.ajax({type:"POST",url:host+'vcode/push',
		   dataType: 'json',
	      contentType: "application/json",
	      data:sentData,
	      async:true,
